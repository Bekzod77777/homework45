      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="card-links">
            <a href="todo.html" onclick="saveId(${data.id})" class="btn btn-danger">Go todo</a>
            <a href="posts.html" onclick="saveId(${data.id})" class="btn btn-danger">Go posts</a>
            <a href="album.html" onclick="saveId(${data.id})" class="btn btn-danger">Go album</a>
          </div>
        </div>
      </div>
    </div>
